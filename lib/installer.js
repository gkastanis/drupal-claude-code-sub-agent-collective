...
`));
  ...
  displayMCPSummary() {
    ...
    if (!this.options.withPlaywright && !this.options.withAllMcps) {
      console.log(chalk.green('\n💡 Tip: Playwright excluded by default to prevent zombie processes'));
      console.log(chalk.gray('    Use --with-playwright if you need visual regression testing'));
    }
  }
}
