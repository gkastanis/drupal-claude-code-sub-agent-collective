  ...
  getArgumentSuggestions(namespace, command, partialArgs) {
    ...
    if (namespace === 'collective') {
      ...
      if (command === 'spawn') {
        if (argIndex === 0) {
          suggestions.push(
            { text: 'module-development', description: 'Custom Drupal module development agent', type: 'argument' },
            { text: 'theme-development', description: 'Drupal theme and front-end agent', type: 'argument' },
            { text: 'functional-testing', description: 'Behat/Playwright testing agent', type: 'argument' },
            { text: 'drupal-architect', description: 'Site architecture and planning agent', type: 'argument' },
            { text: 'performance-devops', description: 'Performance optimization and DevOps agent', type: 'argument' },
            { text: 'behavioral-transformation', description: 'CLAUDE.md transformation agent', type: 'argument' }
          );
        } else if (argIndex === 1) {
          suggestions.push(
            { text: 'behat-functional', description: 'Behat functional testing specialization', type: 'argument' },
            { text: 'phpunit-kernel', description: 'PHPUnit kernel testing specialization', type: 'argument' },
            { text: 'playwright-browser', description: 'Playwright browser testing specialization', type: 'argument' },
            { text: 'caching-optimization', description: 'Performance and caching specialization', type: 'argument' },
            { text: 'wcag-compliance', description: 'WCAG accessibility compliance specialization', type: 'argument' }
          );
        }
        ...
        suggestions.push(
          ...
          { text: 'drupal-architect', description: 'Drupal architecture and planning agent', type: 'argument' },
          { text: 'module-development-agent', description: 'Custom module development agent', type: 'argument' },
          { text: 'theme-development-agent', description: 'Theme and front-end development agent', type: 'argument' },
          { text: 'functional-testing-agent', description: 'Functional testing agent', type: 'argument' }
        );
      }
