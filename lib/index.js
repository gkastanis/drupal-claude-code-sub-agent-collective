...
class ClaudeCodeCollective {
  ...
  getInfo() {
    return {
      ...
      description: 'Drupal-focused sub-agent collective framework for Claude Code with specialized Drupal agents, quality gates, and automated handoffs',
      features: [
        'Drupal 10/11 Specialized Agents',
