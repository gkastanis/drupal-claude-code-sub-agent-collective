...
class FileMapping {
  ...
  getRulesMapping() {
    const rules = [
      ...
      {
        file: 'drupal-contrib-first.md',
        description: 'Check drupal.org for existing modules before writing custom code'
      }
    ];
  ...
  getHookMapping() {
    const hooks = [
      ...
      {
        file: 'plan-quality-inject.sh',
        required: true,
        description: 'Injects routing and quality requirements when plan approved for Drupal work'
      },
      {
